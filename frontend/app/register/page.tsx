      ...
      <div className="w-full max-w-md fade-in-up">
        ...
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-zinc-400 text-center">
            Create an account to unlock instant ATS scoring and resume feedback
          </p>
        </div>
        ...
        <p className="text-center text-sm text-zinc-450 mt-6">
          ...
          <Link href="/login" className="text-emerald-455 hover:underline hover:text-emerald-400 transition-colors">
            Sign in
          </Link>
        </p>
      </div>
